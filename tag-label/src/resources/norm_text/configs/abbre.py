ABBRE = {
    ...
    # 'CSB': 'cảnh sát biển',
    # 'XS': 'xổ số',
    # 'TT-TTCP': 'thông tư thanh tra chính phủ',
    # 'TT.TTCP': 'thông tư thanh tra chính phủ',
    # 'TT-BLĐTBXH': 'thông tư bộ lao động thương bình và xã hội',
    # 'TT.BLĐTBXH': 'thông tư bộ lao động thương bình và xã hội',
    # 'BLĐTBXH': 'bộ lao động thương bình và xã hội',
    ...
    # 'KHLCNT': 'kê hoạch lựa chọn nhà thầu',
    ...
    # 'QT': 'quốc tế',
    # 'HHHV': 'hoa hậu hoàn vũ',
    # 'LLTP': 'lí lịch tư pháp',
    ...
    # 'BPCK': 'biên phòng cửa khẩu',
    # 'GDPT': 'gia đình phật tử',
    ...
    # 'TTKTTV': 'trung tâm khí tượng thuỷ văn',
    # 'XDNTM': 'xây dựng nông thôn mới',
    # 'BLTTDS': 'bộ luật tố tụng dân sự',
    # 'PCCN': 'phòng chống cháy nổ',
    # 'PCTPMT': 'phòng chống tội phạm ma tuý',
    # 'MG/KG': 'miligram trên kilogram',
    # 'GSHT': 'giám sát hành trình',
    # 'NDTV': 'nhân dân tự vệ',
    # 'CBPG': 'chống bán phá giá',
    # 'CMT': 'chứng minh thư',
    # 'TTDH': 'thách thức danh hài',
    ...
    # 'CTRL': 'control',
    # 'PKL': 'phân khối lớn',
    # 'QSMT': 'quay số mở thưởng',
    # 'THADS': 'thi hành án dân sự',
    # 'SGGPO': 'Sài Gòn giải phóng',
    ...
    # 'PT-TH': 'phân tích-tổng hợp',
    # 'SKHCNMT': 'Sở Khoa học Công nghệ và Môi trường',
    # 'SKHĐT': 'Sở Kế hoạch và Đầu tư',
    # 'SV-HS': 'Sinh viên học sinh',
    # 'CMT/CCCD': 'chứng minh thư hoặc căn cước công dân',
    ...
    # 'VNDC': 'vi en đi xi',
    # 'BTP': 'bộ tư pháp',
    # 'BCA': 'bộ tư pháp bộ công an',
    # 'TTBH': 'trung tâm bảo hành',
    # 'VND Credit': 'vi en đi cờ re đít',
    # 'KH': 'khách hàng',
    ...
    # 'LĐ-TB-XH': 'lao động thương bình xã hội',
